...
<%--        <div>root</div>--%>
    ...
    <span id="chatArea">
      <h2>聊天区</h2>
      <span id="chatContext">
<%--        <p><span class="chatFont">root 用户进入了直播间</span></p>--%>
<%--        <p style="float: left"><span class="chatFont">张三:你好</span></p>--%>
<%--        <br/><br/><br/><br/><br/>--%>
<%--        <p style="float: right"><span class="chatFont">我:你好</span></p><br/>--%>
      </span>
    </span>
        ...
        if (str_data.startsWith("user:")) {
          ...
          if (str_data.substring(5).startsWith("<%=loggedInUsername%>:")) {
            ...
            document.getElementById("chatContext").innerHTML += "<p style=" +
                "'float: right; border: gray solid 3px; margin-top:5px; border-radius:10px; background-color: greenyellow;'>" +
                "<span class='chatFont'>"
                  + str_data.substring(5) +
                "</span></p>";
            document.getElementById("chatContext").innerHTML += "<br/><br/><br/>";
            ...
            // 放到聊天区作为其他用户输入
            document.getElementById("chatContext").innerHTML += "<p style=" +
                "'float: left; border: gray solid 3px; margin-top: 5px; border-radius:10px; background-color: white;'>" +
                "<span class='chatFont'>"
                  + str_data.substring(5) +
                "</span></p>";
            document.getElementById("chatContext").innerHTML += "<br/><br/><br/>";
