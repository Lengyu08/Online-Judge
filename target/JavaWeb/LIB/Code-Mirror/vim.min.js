!(function (e) {
  ...
  var Ze = [
        ...
        // User Set Start
        {keys: "<Space>", type: "keyToKey", toKeys: "10", context: "visual"},
        {keys: "<Space>", type: "keyToKey", toKeys: "10", context: "normal"},

        {keys: "df", type: "keyToKey", toKeys: "<Esc>", context: "insert"},
        {keys: "aa", type: "keyToKey", toKeys: "<Esc>la", context: "insert"},
        {keys: "H", type: "motion", motion: "moveToStartOfLine"},
        {
          keys: "L",
          type: "motion",
  ...
  Xe.Vim = (function () {
    function e(e, t) {
      var r;
      this == Xe.keyMap.vim &&
      (Xe.rmClass(e.getWrapperElement(), "cm-fat-cursor"),
      "contenteditable" == e.getOption("inputStyle") &&
      null != document.body.style.caretColor &&
      (a((r = e)),
          r.off("cursorActivity", o),
          (r.state.fatCursorMarks = null),
          (e.getInputField().style.caretColor = ""))),
      (t && t.attach == n) ||
      ((e = e).setOption("disableInput", !1),
          e.off("cursorActivity", Ve),
          Xe.off(e.getInputField(), "paste", l(e)),
          (e.state.vim = null));
    }
    ...
    function n(e, t) {
      var r;
      this == Xe.keyMap.vim &&
      (Xe.addClass(e.getWrapperElement(), "cm-fat-cursor"),
      "contenteditable" == e.getOption("inputStyle") &&
      null != document.body.style.caretColor &&
      (((r = e).state.fatCursorMarks = []),
          o(r),
          r.on("cursorActivity", o),
          (e.getInputField().style.caretColor = "transparent"))),
      (t && t.attach == n) ||
      ((e = e).setOption("disableInput", !0),
          e.setOption("showCursorWhenSelecting", !1),
          Xe.signal(e, "vim-mode-change", {mode: "normal"}),
          e.on("cursorActivity", Ve),
          I(e),
          Xe.on(e.getInputField(), "paste", l(e)));
    }
      ...
      if (e.state.fatCursorMarks) {
        ...
        for (var t = e.listSelections(), r = [], n = 0; n < t.length; n++) {
          ...
          ((o = e.getLine(i.anchor.line).length),
              i.anchor.ch < o
                  ? r.push(
                      e.markText(i.anchor, et(i.anchor.line, i.anchor.ch + 1), {
                        className: "cm-fat-cursor-mark",
                      })
                  )
                  : r.push(
                      e.markText(et(i.anchor.line, o - 1), et(i.anchor.line, o), {
                        className: "cm-fat-cursor-mark",
                      })
                  ));
        }
      ...
      if (t) {
        ...
        var r = (function (e) {
              ...
              e = t[t.length - 1];
          {
            ...
            if (2 == t.length && "Shift" == t[0] && 1 == e.length) return !1;
          }
          for (var r = !1, n = 0; n < t.length; n++) {
            var o = t[n];
            o in i ? (t[n] = i[o]) : (r = !0), o in s && (t[n] = s[o]);
          }
          if (!r) return !1;
          C(e) && (t[t.length - 1] = e.toLowerCase());
          return "<" + t.join("-") + ">";
        })(e);
        if (!r) return !1;
        e = Xe.Vim.findKey(t, r);
        return "function" == typeof e && Xe.signal(t, "vim-keypress", r), e;
      }
    }

    Xe.defineOption("vimMode", !1, function (e, t, r) {
    ...
    var i = {
        ...
        s = {Enter: "CR", Backspace: "BS", Delete: "Del", Insert: "Ins"};
    ...
    var c = /[\d]/,
        m = [
          Xe.isWordChar,
          function (e) {
            return e && !Xe.isWordChar(e) && !/\s/.test(e);
          },
        ],
        g = [
          function (e) {
    ...
    function S(e, t, r, n, o) {
      ...
      if (
          ((M[e] = {type: (r = r || "string"), defaultValue: t, callback: o}),
              n)
      )
        for (var i = 0; i < n.length; i++) M[n[i]] = M[e];
      t && b(e, t);
    }
    ...
    function b(e, t, r, n) {
      ...
      o.callback
          ? ("local" !== n && o.callback(t, void 0),
          "global" !== n && r && o.callback(t, r))
          : ("local" !== n && (o.value = "boolean" == o.type ? !!t : t),
          "global" !== n && r && (r.state.vim.options[e] = {value: t}));
    }
    ...
    function L(e, t, r) {
      ...
      if (n.callback) {
        var o = t && n.callback(void 0, t);
        return "global" !== r && void 0 !== o
            ? o
            : "local" !== r
                ? n.callback()
                : void 0;
      ...
      return (
          (o = "global" !== r && t && t.state.vim.options[e]) ||
          ("local" !== r && n) ||
          {}
      ).value;
    }

    S("filetype", void 0, "string", ["ft"], function (e, t) {
      if (void 0 !== t) {
    ...
    p = {
      ...
      getRegisterController: function () {
        return E.registerController;
      },
      resetVimGlobalState_: N,
      getVimGlobalState_: function () {
        return E;
      },
      maybeInitVimState_: I,
      suppressErrorLogging: !(B.prototype = {
        exitMacroRecordMode: function () {
          var e = E.macroModeState;
          e.onRecordingDone && e.onRecordingDone(),
              (e.onRecordingDone = void 0),
              (e.isRecording = !1);
        },
        enterMacroRecordMode: function (e, t) {
          var r = E.registerController.getRegister(t);
          r &&
          (r.clear(),
              (this.latestRegister = t),
          e.openDialog &&
          (this.onRecordingDone = e.openDialog(
              document.createTextNode("(recording)[" + t + "]"),
              null,
              {bottom: !0}
          )),
              (this.isRecording = !0));
      ...
      noremap: function (e, t, r) {
        ...
        for (var o = n(r), i = Ze.length, a = i - Ge; a < i && o.length; a++) {
          var s = Ze[a];
          if (
              !(
                  s.keys != t ||
          ...
          for (var o = n.length - 1; 0 <= o; o--) {
            ...
            if (e !== i.context)
              if (i.context) this._mapCommand(i);
                ...
                var a,
                    s = ["normal", "insert", "visual"];
                for (a in s)
                  if (s[a] !== e) {
                    var l,
                        c = {};
                    for (l in i) c[l] = i[l];
                    (c.context = s[a]), this._mapCommand(c);
                  }
              }
          }
      },
      ...
      defineEx: function (e, t, r) {
        ...
        (_e[e] = r),
            (He.commandMap_[t] = {name: e, shortName: t, type: "api"});
      },
      handleKey: function (e, t, r) {
        r = this.findKey(e, t, r);
        if ("function" == typeof r) return r();
      },
      findKey: function (s, l, r) {
        var e,
            c = I(s);
        ...
        function o() {
          var e,
              t = E.macroModeState;
          if (t.isRecording) {
            if ("q" == l) return t.exitMacroRecordMode(), P(s), 1;
            "mapping" != r &&
            ((e = l),
            (t = t).isPlaying ||
            ((t = t.latestRegister),
            (t = E.registerController.getRegister(t)) && t.pushText(e)));
          }
        }
        ...
        function u() {
          return (
              "<Esc>" == l &&
              (P(s), c.visualMode ? le(s) : c.insertMode && Fe(s), 1)
          );
        }
            ...
            c.insertMode
                ? function () {
                  ...
                  for (
                      var e = (c.inputState.keyBuffer =
                          ...
                          t = 1 == l.length,
                          r = F.matchCommand(e, Ze, c.inputState, "insert");
                      1 < e.length && "full" != r.type;
                  ) {
                    var e = (c.inputState.keyBuffer = e.slice(1)),
                        n = F.matchCommand(e, Ze, c.inputState, "insert");
                    "none" != n.type && (r = n);
                  }
                  ...
                  if ("partial" == r.type)
                    return (
                        O && window.clearTimeout(O),
                            ...
                            }, L("insertModeEscKeysTimeout"))),
                            !t
                    );
                  if ((O && window.clearTimeout(O), t)) {
                    for (var o = s.listSelections(), i = 0; i < o.length; i++) {
                      var a = o[i].head;
                      s.replaceRange("", q(a, 0, -(e.length - 1)), a, "+input");
                    }
                    E.macroModeState.lastInsertModeChanges.changes.pop();
                  }
                ...
                : function () {
                  ...
                  var r = c.visualMode ? "visual" : "normal",
                      n = t[2] || t[1];
                  return (
                      c.inputState.operatorShortcut &&
                      c.inputState.operatorShortcut.slice(-1) == n &&
                      (n = c.inputState.operatorShortcut),
                          "none" == (r = F.matchCommand(n, Ze, c.inputState, r)).type
                              ? (P(s), !1)
                              : "partial" == r.type ||
                  ...
                  return s.operation(function () {
                    ...
                    try {
                      ...
                      throw (
                          ((s.state.vim = void 0),
                              I(s),
                          Xe.Vim.suppressErrorLogging || console.log(e),
                              e)
                      );
                    }
                    return !0;
      ...
      mapCommand: function (e, t, r, n, o) {
        var i,
            a = {keys: e, type: t};
        for (i in ((a[t] = r), (a[t + "Args"] = n), o)) a[i] = o[i];
        We(a);
      },
      _mapCommand: We,
      defineRegister: function (e, t) {
        var r = E.registerController.registers;
        if (!e || 1 != e.length)
    ...
    function P(e, t) {
      (e.state.vim.inputState = new K()), Xe.signal(e, "vim-command-done", t);
    }
      ...
      this.operator
        ...
        (j.prototype = {
          ...
          pushInsertModeChanges: function (e) {
            this.insertModeChanges.push(R(e));
          },
        ...
        (_.prototype = {
          pushText: function (e, t, r, n, o) {
            if ("_" !== e) {
              ...
              if (i)
                C(e) ? i.pushText(r, n) : i.setText(r, n, o),
    ...
    var F = {
                ...
                !(o = (function (e, t) {
                  {
                    ...
                    var r = t.length - 11,
                        n = e.slice(0, r),
                        t = t.slice(0, r);
                    return n == t && e.length > r
                        ? "full"
                        : 0 == t.indexOf(n) && "partial";
                  }
                })(e, l.keys)) ||
          ...
          processMotion: function (e, t, r) {
            (t.inputState.motion = r.motion),
                (t.inputState.motionArgs = J(r.motionArgs)),
                this.evalInput(e, t);
          },
          ...
          processSearch: function (a, n, o) {
            if (a.getSearchCursor) {
              var s = o.searchArgs.forward,
              ...
              switch (o.searchArgs.querySrc) {
                case "prompt":
                  var r = E.macroModeState;
                  r.isPlaying
                      ? h((u = r.replaySearchQueries.shift()), !0, !1)
                      : Re(a, {
                        onClose: p,
                        prefix: t,
                        ...
                        onKeyUp: function (e, t, r) {
                          var n,
                              ...
                              i = Xe.keyName(e);
                          "Up" == i || "Down" == i
                              ? ((n = e.target ? e.target.selectionEnd : 0),
                                  r(
                                      (t =
                                          E.searchHistoryController.nextMatch(
                                              t,
                                              "Up" == i
                                          ) || "")
                                  ),
                              ...
                              (e.target.selectionEnd = e.target.selectionStart =
                                  Math.min(n, e.target.value.length)))
                              : "Left" != i &&
                              "Right" != i &&
                              "Ctrl" != i &&
                              "Alt" != i &&
                              "Shift" != i &&
                              E.searchHistoryController.reset();
                          try {
                            o = Ee(a, t, !0, !0);
                          } catch (e) {
                          }
                          o
                              ? a.scrollIntoView(Ie(a, !s, o), 30)
                              : (Ne(a), a.scrollTo(l.left, l.top));
                        },
                        onKeyDown: function (e, t, r) {
                          ...
                          "Ctrl-[" == n ||
                          ("Backspace" == n && "" == t)
                              ? (E.searchHistoryController.pushInput(t),
                                  E.searchHistoryController.reset(),
                                  Ee(a, i),
                                  Ne(a),
                                  a.scrollTo(l.left, l.top),
                                  Xe.e_stop(e),
                                  P(a),
                                  r(),
                                  a.focus())
                ...
                case "wordUnderCursor":
                  var c = ue(a, !1, 0, !1, !0),
                      r = !0;
                  if ((c || ((c = ue(a, !1, 0, !1, !1)), (r = !1)), !c)) return;
                  var u = a.getLine(c.start.line).substring(c.start.ch, c.end.ch);
                  (u =
                      r && e
                          ? "\\b" + u + "\\b"
                          : u.replace(/([.?*+$\[\]\/\\(){}|\-])/g, "\\$1")),
                      (E.jumpList.cachedCursor = a.getCursor()),
                      a.setCursor(c.start),
                      h(u, !0, !1);
              }
            }
            ...
            function h(t, e, r) {
              ...
              try {
                ...
                return Te(a, "Invalid regex: " + t), void P(a);
              }
              F.processMotion(a, n, {
                type: "motion",
                motion: "findNext",
            ...
            function p(e) {
              a.scrollTo(l.left, l.top), h(e, !0, !0);
              var t = E.macroModeState;
              t.isRecording &&
              ((e = e),
              (t = t).isPlaying ||
              ((t = t.latestRegister),
              (t = E.registerController.getRegister(t)) &&
              t.pushSearchQuery &&
              t.pushSearchQuery(e)));
            }
          },
          processEx: function (i, e, t) {
            function r(e) {
              E.exCommandHistoryController.pushInput(e),
                  E.exCommandHistoryController.reset(),
                  He.processCommand(i, e);
            }
            ...
            function n(e, t, r) {
              ...
              ("Esc" == o ||
                  ...
                  "Ctrl-[" == o ||
                  ("Backspace" == o && "" == t)) &&
              (E.exCommandHistoryController.pushInput(t),
                  E.exCommandHistoryController.reset(),
                  Xe.e_stop(e),
                  P(i),
                  r(),
                  ...
                  "Up" == o || "Down" == o
                      ? (Xe.e_stop(e),
                          ...
                          r(
                              (t =
                                  E.exCommandHistoryController.nextMatch(t, "Up" == o) ||
                                  "")
                          ),
                      n &&
                      e.target &&
            ...
            "keyToEx" == t.type
                ? He.processCommand(i, t.exArgs.input)
                : e.visualMode
                    ? Re(i, {
                      onClose: r,
                      prefix: ":",
                    ...
                    : Re(i, {onClose: r, prefix: ":", onKeyDown: n});
          },
          evalInput: function (e, t) {
            var r,
                ...
                p = s.registerName,
                d = t.sel,
                f = z(t.visualMode ? U(e, d.head) : e.getCursor("head")),
                m = z(t.visualMode ? U(e, d.anchor) : e.getCursor("anchor")),
                g = z(f),
                v = z(m);
            if (
                (u && this.recordLastEdit(t, s),
                    0 <
                    (m =
                        void 0 !== s.repeatOverride
                            ? s.repeatOverride
                            : s.getRepeat()) && c.explicitRepeat
                        ? (c.repeatIsExplicit = !0)
                        : (c.noRepeat || (!c.explicitRepeat && 0 === m)) &&
                        (c.repeatIsExplicit = !(m = 1)),
                s.selectedCharacter &&
                (c.selectedCharacter = h.selectedCharacter = s.selectedCharacter),
                    (c.repeat = m),
                    P(e),
                    l)
            ) {
              var y,
                  k = W[l](e, f, c, t, s);
              if (((t.lastMotion = W[l]), !k)) return;
              c.toJumplist &&
              ((S = (y = E.jumpList).cachedCursor)
                  ? (he(e, S, k), delete y.cachedCursor)
                  : he(e, f, k)),
                  (S = (S = k instanceof Array ? ((r = k[0]), k[1]) : k) || z(f)),
                  t.visualMode
                      ? ((t.visualBlock && S.ch === 1 / 0) || (S = U(e, S)),
                          (r = r && U(e, r)),
                          (d.anchor = r = r || v),
                          (d.head = S),
                          ae(e),
                          ve(e, t, "<", Z(r, S) ? r : S),
                          ve(e, t, ">", Z(r, S) ? S : r))
                      : u || ((S = U(e, S)), e.setCursor(S.line, S.ch));
            }
            if (u) {
              if (
                  (h.lastSel
                      ? ((r = v),
                          (y = h.lastSel),
                          (k = Math.abs(y.head.line - y.anchor.line)),
                          (f = Math.abs(y.head.ch - y.anchor.ch)),
                          (S = y.visualLine
                              ? et(v.line + k, v.ch)
                              : y.visualBlock
                                  ? et(v.line + k, v.ch + f)
                ...
                if (
                    ((o = G(d.head, d.anchor)),
                        (i = Y(d.head, d.anchor)),
                        (n = t.visualLine || h.linewise),
                        (M = se(
                            e,
                            {anchor: o, head: i},
                            (x = t.visualBlock ? "block" : n ? "line" : "char")
                        )),
                        n)
                ) {
                  var C = M.ranges;
                  if ("block" == x)
                    for (var w = 0; w < C.length; w++)
                      C[w].head.ch = te(e, C[w].head.line);
                  else "line" == x && (C[0].head = et(C[0].head.line + 1, 0));
                }
              } else {
                (o = z(r || v)),
                Z((i = z(S || g)), o) && ((a = o), (o = i), (i = a)),
                    (n = c.linewise || h.linewise)
                        ? ((a = i), (o.ch = 0), (a.ch = 0), a.line++)
                        : c.forward &&
                        (function (e, t, r) {
                          t = e.getRange(t, r);
                          if (/\n\s*$/.test(t)) {
                ...
                var x = "char",
                    c = !c.inclusive || n,
                    M = se(e, {anchor: o, head: i}, x, c);
              }
              e.setSelections(M.ranges, M.primary),
                  (t.lastMotion = null),
                  (h.repeat = m),
                  (h.registerName = p),
                  (h.linewise = n);
              var S = V[u](e, h, M.ranges, v, S);
              t.visualMode && le(e, null != S), S && e.setCursor(S);
            }
          },
          recordLastEdit: function (e, t, r) {
            var n = E.macroModeState;
            n.isPlaying ||
        ...
        W = {
          moveToTopLine: function (e, t, r) {
            r = Ke(e).top + r.repeat - 1;
            return et(r, ce(e.getLine(r)));
          },
          moveToMiddleLine: function (e) {
            var t = Ke(e),
                t = Math.floor(0.5 * (t.top + t.bottom));
            return et(t, ce(e.getLine(t)));
          },
          moveToBottomLine: function (e, t, r) {
            r = Ke(e).bottom - r.repeat + 1;
            return et(r, ce(e.getLine(r)));
          },
          expandToLine: function (e, t, r) {
            return et(t.line + r.repeat - 1, 1 / 0);
          },
          ...
          findAndSelectNextInclusive: function (e, t, r, n, o) {
            ...
            if (a) {
                    ...
                    return o.operation(function () {
                      ...
                      for (var n = 0; n < s; n++)
                        if (
                            ...
                            !(t = o.getSearchCursor(
                                a,
                                i ? et(o.lastLine()) : et(o.firstLine(), 0)
                            )).find(i)
                        )
                          return;
                      return [t.from(), t.to()];
              ...
              if (l) {
                ...
                (a = l[0]), (o = et(l[1].line, l[1].ch - 1));
                if (n.visualMode) {
                  (n.visualLine || n.visualBlock) &&
                  ((n.visualLine = !1),
                      (n.visualBlock = !1),
                      Xe.signal(e, "vim-mode-change", {
                        mode: "visual",
                        subMode: "",
                      }));
                  l = n.sel.anchor;
          ...
          goToMark: function (e, t, r, n) {
            n = Pe(e, n, r.selectedCharacter);
            return n
                ? r.linewise
                    ? {line: n.line, ch: ce(e.getLine(n.line))}
                    : n
                : null;
          },
          moveToOtherHighlightedEnd: function (e, t, r, n) {
            if (n.visualBlock && r.sameLine) {
              r = n.sel;
              return [
                U(e, et(r.anchor.line, r.head.ch)),
                U(e, et(r.head.line, r.anchor.ch)),
              ];
            }
          ...
          jumpToMark: function (e, t, r, n) {
            for (var o = t, i = 0; i < r.repeat; i++) {
              ...
              for (a in n.marks)
                k(a) &&
                ((s = n.marks[a].find()),
                (r.forward ? Z(s, u) : Z(u, s)) ||
                (r.linewise && s.line == u.line) ||
                ((l = X(u, o)),
                    (c = r.forward ? ee(u, s, o) : ee(o, s, u)),
                (l || c) && (o = s)));
            }
            return (o = r.linewise ? et(o.line, ce(e.getLine(o.line))) : o);
          },
          moveByCharacters: function (e, t, r) {
            var n = r.repeat,
                n = r.forward ? t.ch + n : t.ch - n;
            return et(t.line, n);
          },
          moveByLines: function (e, t, r, n) {
            ...
            var a = r.repeat + (r.repeatOffset || 0),
                ...
                l = e.firstLine(),
                c = e.lastLine(),
                a = e.findPosV(o, r.forward ? a : -a, "line", n.lastHSPos);
            return (
                (r.forward ? a.line > s : a.line < s) && ((s = a.line), (i = a.ch)),
                    s < l && o.line == l
                        ? this.moveToStartOfLine(e, t, r, n)
                        : c < s && o.line == c
                            ? me(e, t, r, n, !0)
                            : (r.toFirstChar && ((i = ce(e.getLine(s))), (n.lastHPos = i)),
                                (n.lastHSPos = e.charCoords(et(s, i), "div").left),
                                et(s, i))
            );
          },
          moveByDisplayLines: function (e, t, r, n) {
            ...
            var i,
                t = r.repeat,
                t = e.findPosV(o, r.forward ? t : -t, "line", n.lastHSPos);
            return (
                t.hitSide &&
                (t = r.forward
                    ? ((i = {
                      top: e.charCoords(t, "div").top + 8,
                      left: n.lastHSPos,
                    }),
                        e.coordsChar(i, "div"))
                    : (((i = e.charCoords(et(e.firstLine(), 0), "div")).left =
                        n.lastHSPos),
                        e.coordsChar(i, "div"))),
                    (n.lastHPos = t.ch),
                    t
          ...
          moveByScroll: function (e, t, r, n) {
            ...
            if (((r.repeat = a), !(i = W.moveByDisplayLines(e, t, r, n))))
              return null;
            n = e.charCoords(i, "local");
            return e.scrollTo(null, o.top + n.top - s.top), i;
          },
          moveByWords: function (e, t, r) {
            return (function (e, t, r, n, o, i) {
              ...
              for (var l = !(n && o), c = 0; c < r; c++) {
                var u = (function (e, t, r, n, o) {
                  ...
                  for (; ;) {
                    ...
                    for (var u = 0 < l ? s.length : -1, h = u, p = u; a != u;) {
                      for (var d = !1, f = 0; f < c.length && !d; ++f)
                        if (c[f](s.charAt(a))) {
                          for (h = a; a != u && c[f](s.charAt(a));) a += l;
                          if (
                              ((d = h != (p = a)),
                ...
                s.push(u), (t = et(u.line, n ? u.to - 1 : u.from));
              }
              var p = s.length != r,
                  d = s[0],
                  f = s.pop();
              return n && !o
                  ? (p || (d.from == a.ch && d.line == a.line) || (f = s.pop()),
                      et(f.line, f.from))
                  : n && o
                      ? et(f.line, f.to - 1)
                      : !n && o
                          ? (p || (d.to == a.ch && d.line == a.line) || (f = s.pop()),
                              et(f.line, f.to))
                          : et(f.line, f.from);
                    ...
                    ((l += i),
                        ...
                        0 < i
                            ...
                            : ((p = u.lineText.length),
                                (u.index = 0 < p ? p - 1 : 0)),
                        (u.nextCh = u.lineText.charAt(u.index))),
                    h(u) && ((o.line = l), (o.ch = u.index), t--);
                  }
                  if (u.nextCh || u.curMoveThrough) return et(l, u.index);
                  return o;
          ...
          moveToFirstNonWhiteSpaceCharacter: function (e, t) {
            return et(t.line, ce(e.getLine(t.line)));
          },
          moveToMatchedSymbol: function (e, t) {
            for (
                var r = t, n = r.line, o = r.ch, i = e.getLine(n);
                o < i.length;
                o++
            )
              if ((a = i.charAt(o)) && -1 != "()[]{}".indexOf(a)) {
                var a = e.getTokenTypeAt(et(n, o + 1));
                if ("string" !== a && "comment" !== a) break;
              }
            if (o < i.length) {
              t = "<" === o || ">" === o ? /[(){}[\]<>]/ : /[(){}[\]]/;
              return e.findMatchingBracket(et(n, o), {bracketRegex: t}).to;
            }
            return r;
          },
            ...
            if (
              ...
              a = (function (e, t, r, n) {
                var o = t,
                    ...
                    r = e.getLine(o.line).charAt(o.ch) === t ? 1 : 0;
                if (
                    ((t = e.scanForBracket(et(o.line, o.ch + r), -1, void 0, {
                      bracketRegex: i,
                    })),
                        (i = e.scanForBracket(et(o.line, o.ch + r), 1, void 0, {
                          bracketRegex: i,
                        })),
                    !t || !i)
                )
                ...
                (t = t.pos),
                    (i = i.pos),
                ((t.line == i.line && t.ch > i.ch) || t.line > i.line) &&
                ((o = t), (t = i), (i = o));
                n ? (i.ch += 1) : (t.ch += 1);
              ...
              a = (function (e, t, r, n) {
                var o,
                    ...
                    s,
                    t = z(t),
                    l = e.getLine(t.line).split(""),
                    e = l.indexOf(r);
                t.ch < e
                    ? (t.ch = e)
                    : e < t.ch && l[t.ch] == r && ((i = t.ch), --t.ch);
                if (l[t.ch] != r || i)
                  for (a = t.ch; -1 < a && !o; a--) l[a] == r && (o = a + 1);
                else o = t.ch + 1;
                if (o && !i)
                  for (a = o, s = l.length; a < s && !i; a++)
                    l[a] == r && (i = a);
                if (!o || !i) return {start: t, end: t};
                n && (--o, ++i);
                return {start: et(t.line, o), end: et(t.line, i)};
              })(e, t, o, i);
            else if ("W" === o) a = ue(e, i, 0, !0);
            else if ("w" === o) a = ue(e, i, 0, !1);
            else if ("p" === o) {
              var a = ye(e, t, r.repeat, 0, i);
              (r.linewise = !0),
                  n.visualMode
                      ? n.visualLine || (n.visualLine = !0)
                      : ((n = n.inputState.operatorArgs) && (n.linewise = !0),
                          a.end.line--);
            } else {
              if ("t" !== o) return null;
              a = (function (e, t, r) {
                var n = t;
                if (!Xe.findMatchingTag || !Xe.findEnclosingTag)
                  return {start: n, end: n};
                t = Xe.findMatchingTag(e, t) || Xe.findEnclosingTag(e, t);
                if (!t || !t.open || !t.close) return {start: n, end: n};
                if (r) return {start: t.open.from, end: t.close.to};
                return {start: t.open.to, end: t.close.from};
              })(e, t, i);
            }
            return e.state.vim.visualMode
                ? (function (e, t, r) {
                  ...
                  Z(o, i)
                      ? ((o = G(t, o)), (i = Y(i, r)))
                      : ((i = G(t, i)),
                      -1 == (o = q((o = Y(o, r)), 0, -1)).ch &&
                      o.line != e.firstLine() &&
                      (o = et(o.line - 1, te(e, o.line - 1))));
                  return [i, o];
                })(e, a.start, a.end)
                : [a.start, a.end];
          },
          repeatLastCharacterSearch: function (e, t, r) {
            var n = E.lastCharacterSearch,
                o = r.repeat,
                i = r.forward === n.forward,
                a = (n.increment ? 1 : 0) * (i ? -1 : 1);
            e.moveH(-a, "char");
            n = ge(e, o, (r.inclusive = i), n.selectedCharacter);
            return n ? ((n.ch += a), n) : (e.moveH(a, "char"), t);
          },
        };
    ...
    var V = {
      change: function (e, t, r) {
        var n,
            ...
            s = a.visualMode
                ...
                : ((o = e.getRange(s, l)),
                "moveByWords" != (a = a.lastEditInputState || {}).motion ||
                A(o) ||
                ((i = /\s+$/.exec(o)) &&
                    a.motionArgs &&
                    ...
                    (a = new et(s.line - 1, Number.MAX_VALUE)),
                    (i = e.firstLine() == e.lastLine()),
                    l.line > e.lastLine() && t.linewise && !i
                        ? e.replaceRange("", a, l)
                        : e.replaceRange("", s, l),
                t.linewise &&
                (i || (e.setCursor(a), Xe.commands.newlineAndIndent(e)),
                    (s.ch = Number.MAX_VALUE)),
                    s);
        E.registerController.pushText(
            t.registerName,
            "change",
            o,
            t.linewise,
            ...
            $.enterInsertMode(e, {head: s}, e.state.vim);
      },
      delete: function (e, t, r) {
        ...
        return (
            a.visualBlock
                ...
                (i.line == e.firstLine()
                    ? (i.ch = 0)
                    : (i = et(i.line - 1, te(e, i.line - 1)))),
                    (o = e.getRange(i, r)),
                    e.replaceRange("", i, r),
                    (n = i),
                t.linewise && (n = W.moveToFirstNonWhiteSpaceCharacter(e, i))),
                E.registerController.pushText(
                    t.registerName,
                    "delete",
                    o,
      ...
      indent: function (e, t, r) {
        var n = e.state.vim,
            o = r[0].anchor.line,
            i = (n.visualBlock ? r[r.length - 1].anchor : r[0].head).line,
        ...
        for (
          ...
          if (!0 === s) u = c.toLowerCase();
            ...
            for (var h = 0; h < c.length; h++) {
              var p = c.charAt(h);
              u += C(p) ? p.toLowerCase() : p.toUpperCase();
            }
          a.push(u);
        }
        return (
    ...
    var $ = {
      jumpListWalk: function (e, t, r) {
        ...
        ((r = t.repeat),
            (t = t.forward),
            (r =
                (r = (r = E.jumpList.move(e, t ? r : -r)) ? r.find() : void 0) ||
                e.getCursor()),
            e.setCursor(r));
      },
      scroll: function (e, t, r) {
        ...
        r.visualMode ||
        ((o = t.repeat || 1),
            (n = e.defaultTextHeight()),
            (i = e.getScrollInfo().top),
            (r = n * o),
            (o = t.forward ? i + r : i - r),
            (i = z(e.getCursor())),
            (r = e.charCoords(i, "local")),
            t.forward
                ? o > r.top
                    ? ((i.line += (o - r.top) / n),
                        (i.line = Math.ceil(i.line)),
                        e.setCursor(i),
                        (r = e.charCoords(i, "local")),
                        e.scrollTo(null, r.top))
                    : e.scrollTo(null, o)
                : (t = o + e.getScrollInfo().clientHeight) < r.bottom
                    ? ((i.line -= (r.bottom - t) / n),
                        (i.line = Math.floor(i.line)),
                        e.setCursor(i),
                        (r = e.charCoords(i, "local")),
                        e.scrollTo(null, r.bottom - e.getScrollInfo().clientHeight))
                    : e.scrollTo(null, o));
      },
      scrollToCursor: function (e, t) {
        var r = e.getCursor().line,
            r = e.charCoords(et(r, 0), "local"),
            n = e.getScrollInfo().clientHeight,
            o = r.top,
            i = r.bottom - o;
        switch (t.position) {
          case "center":
      ...
      replayMacro: function (e, t, r) {
        ...
        for ("@" == n ? (n = i.latestRegister) : (i.latestRegister = n); o--;)
          !(function (e, t, r, n) {
            var o = E.registerController.getRegister(n);
            if (":" != n) {
              var i = o.keyBuffer,
                  a = 0;
              (r.isPlaying = !0),
              ...
              for (var s = 0; s < i.length; s++)
                for (var l, c, u = i[s]; u;)
                  (l = /<\w+-.+?>|<\w+>|./.exec(u)),
                      ...
                      Xe.Vim.handleKey(e, c, "macro"),
                  t.insertMode &&
                  ((c = o.insertModeChanges[a++].changes),
                      (E.macroModeState.lastInsertModeChanges.changes = c),
                      ze(e, c, 1),
                      Fe(e));
              r.isPlaying = !1;
            } else
              o.keyBuffer[0] && He.processCommand(e, o.keyBuffer[0]),
                  (r.isPlaying = !1);
          })(e, r, i, n);
      },
      enterMacroRecordMode: function (e, t) {
        var r = E.macroModeState,
            t = t.selectedCharacter;
        E.registerController.isValidRegister(t) && r.enterMacroRecordMode(e, t);
      },
      toggleOverwrite: function (e) {
        e.state.overwrite
            ? (e.toggleOverwrite(!1),
                e.setOption("keyMap", "vim-insert"),
                Xe.signal(e, "vim-mode-change", {mode: "insert"}))
            : (e.toggleOverwrite(!0),
                e.setOption("keyMap", "vim-replace"),
                Xe.signal(e, "vim-mode-change", {mode: "replace"}));
      },
      enterInsertMode: function (e, t, r) {
        if (!e.getOption("readOnly")) {
          ...
          if ("eol" == n) i = et(i.line, te(e, i.line));
          else if ("bol" == n) i = et(i.line, 0);
            ...
            r.visualBlock
                ...
                : (i =
                    o.head.line < o.anchor.line ? o.head : et(o.anchor.line, 0));
          ...
          e.setOption("disableInput", !1),
              t && t.replace
                  ...
                  : (e.toggleOverwrite(!1),
                      e.setOption("keyMap", "vim-insert"),
                      Xe.signal(e, "vim-mode-change", {mode: "insert"})),
          E.macroModeState.isPlaying ||
          (e.on("change", De), Xe.on(e.getInputField(), "keydown", qe)),
          r.visualMode && le(e),
              oe(e, i, a);
        }
      },
      toggleVisualMode: function (e, t, r) {
        ...
        r.visualMode
            ...
            : ((r.visualMode = !0),
                (r.visualLine = !!t.linewise),
                (r.visualBlock = !!t.blockwise),
                (n = U(e, et(o.line, o.ch + n - 1))),
                (r.sel = {anchor: o, head: n}),
                Xe.signal(e, "vim-mode-change", {
                  mode: "visual",
                  subMode: r.visualLine
                      ? "linewise"
      ...
      joinLines: function (e, t, r) {
        ...
        r.visualMode
            ...
            Z((n = e.getCursor("head")), o) && ((s = n), (n = o), (o = s)),
                (n.ch = te(e, n.line) - 1))
            : ((c = Math.max(t.repeat, 2)),
                (o = e.getCursor()),
                (n = U(e, et(o.line + c - 1, 1 / 0))));
        for (var i = 0, a = o.line; a < n.line; a++) {
          var i = te(e, o.line),
              s = et(o.line + 1, te(e, o.line + 1)),
              l = e.getRange(o, s),
              l = t.keepSpaces
                  ? l.replace(/\n\r?/g, "")
                  : l.replace(/\n\s*/g, " ");
          e.replaceRange(l, o, s);
        }
        var c = et(o.line, i);
        r.visualMode && le(e, !1), e.setCursor(c);
      },
      newLineAndEnterInsertMode: function (e, t, r) {
        ...
        n.line !== e.firstLine() || t.after
            ? ((n.line = t.after ? n.line : n.line - 1),
                ...
                e.setCursor(n),
                (
                    Xe.commands.newlineAndIndentContinueComment ||
                    Xe.commands.newlineAndIndent
                )(e))
            : (e.replaceRange("\n", et(e.firstLine(), 0)),
      ...
      paste: function (r, e, t) {
        var n,
            ...
            a,
            s = z(r.getCursor()),
            l = E.registerController.getRegister(e.registerName),
            c = l.toString();
        if (c) {
          e.matchIndent &&
          ((n = r.getOption("tabSize")),
              (o = function (e) {
                var t = e.split("\t").length - 1,
                    e = e.split(" ").length - 1;
                return t * n + e;
              }),
              (y = r.getLine(r.getCursor().line)),
              (i = o(y.match(/^\s*/)[0])),
              (C = c.replace(/\n$/, "")),
              (x = c !== C),
              (a = o(c.match(/^\s*/)[0])),
              (c = C.replace(/^\s*/gm, function (e) {
                var t = i + (o(e) - a);
                if (t < 0) return "";
              ...
              (c += x ? "\n" : "")),
          1 < e.repeat && (c = Array(e.repeat + 1).join(c));
          var u,
              h,
              p,
              d,
          ...
          if (y) {
            (c = c.split("\n")), v && c.pop();
            for (var k = 0; k < c.length; k++) c[k] = "" == c[k] ? " " : c[k];
            (s.ch += e.after ? 1 : 0), (s.ch = Math.min(te(r, s.line), s.ch));
          } else
            v
                ? t.visualMode
                    ? (c = t.visualLine
          ...
          if (t.visualMode) {
            ...
            var C =
                        ...
                        (t.visualMode
                            ? function () {
                              ...
                              return [
                                ...
                                Z(e.anchor, e.head) ? e.head : e.anchor,
                              ];
                            }
                            : function () {
                              var e = m.getCursor(),
                              ...
                              if (r) {
                                ...
                                (r = g.anchorMark.find()),
                                    ...
                                    (n = o.line - r.line),
                                    (r = o.ch - r.ch);
                                (t = {line: t.line + n, ch: n ? t.ch : r + t.ch}),
                                g.visualLine &&
                                ((e = et(e.line, 0)),
                                    (t = et(t.line, te(m, t.line)))),
                                    m.setSelection(e, t);
                              }
                              return [e, t];
                            })()),
                ...
                l = r.getSelection(),
                C = r.listSelections(),
                C = new Array(C.length).join("1").split("1");
            t.lastSelection && (h = t.lastSelection.headMark.find()),
                E.registerController.unnamedRegister.setText(l),
                (w = y
                    ? (r.replaceSelections(C),
                        (x = et(w.line + c.length - 1, w.ch)),
                        r.setCursor(w),
                        ne(r, x),
                        r.replaceSelections(c),
                        w)
                    : t.visualBlock
                        ? (r.replaceSelections(C),
                            r.setCursor(w),
                            r.replaceRange(c, w, w),
                            w)
                        : (r.replaceRange(c, w, x),
                            r.posFromIndex(r.indexFromPos(w) + c.length - 1))),
            h && (t.lastSelection.headMark = r.setBookmark(h)),
            v && (w.ch = 0);
          } else if (y) {
            r.setCursor(s);
            for (k = 0; k < c.length; k++) {
              var M = s.line + k;
              M > r.lastLine() && r.replaceRange("\n", et(M, 0)),
              te(r, M) < s.ch &&
              ((p = r),
                  (d = M),
                  (f = s.ch),
                  (M = void 0),
                  (M = te(p, d)),
                  (f = new Array(f - M + 1).join(" ")),
                  p.setCursor(et(d, M)),
                  p.replaceRange(f, p.getCursor()));
            }
            r.setCursor(s),
                ne(r, et(s.line + c.length - 1, s.ch)),
                r.replaceSelections(c),
                (w = s);
          } else
            r.replaceRange(c, s),
                (w =
                    v && e.after
                        ? et(s.line + 1, ce(r.getLine(s.line + 1)))
                        : v && !e.after
                            ? et(s.line, ce(r.getLine(s.line)))
                            : !v && e.after
                                ? ((u = r.indexFromPos(s)), r.posFromIndex(u + c.length - 1))
                                : ((u = r.indexFromPos(s)), r.posFromIndex(u + c.length)));
          t.visualMode && le(r, !1), r.setCursor(w);
        }
      },
      undo: function (e, t) {
        e.operation(function () {
          Q(e, Xe.commands.undo, t.repeat)(),
              e.setCursor(e.getCursor("anchor"));
        });
      },
      redo: function (e, t) {
        Q(e, Xe.commands.redo, t.repeat)();
      },
      ...
      replace: function (e, t, r) {
        var n,
            ...
            s = e.listSelections(),
            t = r.visualMode
                ? ((a = e.getCursor("start")), e.getCursor("end"))
                : ((o = e.getLine(a.line)),
                (n = a.ch + t.repeat) > o.length && (n = o.length),
                    et(a.line, n));
        "\n" == i
            ? (r.visualMode || e.replaceRange("", a, t),
                (
                    Xe.commands.newlineAndIndentContinueComment ||
                    Xe.commands.newlineAndIndent
                )(e))
            : ((o = (o = e.getRange(a, t)).replace(/[^\n]/g, i)),
                r.visualBlock
                    ? ((n = new Array(e.getOption("tabSize") + 1).join(" ")),
                        (o = (o = e.getSelection())
                            .replace(/\t/g, n)
                            .replace(/[^\n]/g, i)
                            .split("\n")),
                        e.replaceSelections(o))
                    : e.replaceRange(o, a, t),
                r.visualMode
                    ? ((a = Z(s[0].anchor, s[0].head) ? s[0].anchor : s[0].head),
                        e.setCursor(a),
                        le(e, !1))
                    : e.setCursor(q(t, 0, -1)));
      },
      incrementNumberToken: function (e, t) {
        ...
        (r &&
            ((s = r[2] || r[4]),
                (l = r[3] || r[5]),
                (i = t.increase ? 1 : -1),
                (a = {"0b": 2, 0: 8, "": 10, "0x": 16}[s.toLowerCase()]),
                (a = (parseInt(r[1] + l, a) + i * t.repeat).toString(a)),
                (l = s
                    ? new Array(l.length - a.length + 1 + r[1].length).join("0")
                    : ""),
                (a = "-" === a.charAt(0) ? "-" + s + l + a.substr(1) : s + l + a),
                (s = et(c.line, n)),
                (l = et(c.line, o)),
                e.replaceRange(a, s, l),
                e.setCursor(et(c.line, n + a.length - 1))));
      },
    ...
    function U(e, t) {
      var r = e.state.vim,
          ...
          r = Math.min(Math.max(e.firstLine(), t.line), e.lastLine()),
          n = te(e, r) - 1 + !!n,
          n = Math.min(Math.max(0, t.ch), n);
      return et(r, n);
    }
    ...
    function G(e, t) {
      return Z(
          ...
          (t =
              2 < arguments.length
                  ? G.apply(void 0, Array.prototype.slice.call(arguments, 1))
                  : t)
      )
          ? e
          : t;
    ...
    function Y(e, t) {
      return Z(
          ...
          (t =
              2 < arguments.length
                  ? Y.apply(void 0, Array.prototype.slice.call(arguments, 1))
                  : t)
      )
          ? t
          : e;
    ...
    function ne(e, t) {
      var r = [],
          ...
          c = a < l - a ? l : 0,
          a = n[c].anchor,
          l = Math.min(a.line, o.line),
          u = Math.max(a.line, o.line),
          h = a.ch,
          p = o.ch,
          n = n[c].head.ch - h,
          c = p - h;
      0 < n && c <= 0
          ...
          : n < 0 && 0 <= c
              ...
              : n < 0 && -1 == c && (h--, p++);
      for (var d = l; d <= u; d++) {
        var f = {anchor: new et(d, h), head: new et(d, p)};
        r.push(f);
      }
      return e.setSelections(r), (t.ch = p), (a.ch = h), a;
    }
    ...
    function ae(e, t, r) {
      ...
      e.setSelections(r.ranges, r.primary), $e(e);
    }
    ...
    function se(e, t, r, n) {
      var o = z(t.head),
          i = z(t.anchor);
      if ("char" == r) {
        var a = n || Z(t.head, t.anchor) ? 0 : 1,
            n = Z(t.head, t.anchor) ? 1 : 0,
            o = q(t.head, 0, a);
        return {
          ranges: [{anchor: (i = q(t.anchor, 0, n)), head: o}],
          primary: 0,
        };
      }
      if ("line" == r)
        return (
            Z(t.head, t.anchor)
                ? ((o.ch = 0), (i.ch = te(e, i.line)))
                : ((i.ch = 0),
                    (t = e.lastLine()),
                o.line > t && (o.line = t),
                    (o.ch = te(e, o.line))),
                {ranges: [{anchor: i, head: o}], primary: 0}
        );
      if ("block" == r) {
        for (
            var s = Math.min(i.line, o.line),
                l = Math.min(i.ch, o.ch),
                r = Math.max(i.line, o.line),
                c = Math.max(i.ch, o.ch) + 1,
                u = r - s + 1,
                o = o.line == s ? 0 : u - 1,
                h = [],
                p = 0;
          ...
          h.push({anchor: et(s + p, l), head: et(s + p, c)});
        return {ranges: h, primary: o};
      }
    }

    function le(e, t) {
      var r = e.state.vim;
      !1 !== t && e.setCursor(U(e, r.sel.head)),
          ie(e, r),
          (r.visualMode = !1),
          (r.visualLine = !1),
          (r.visualBlock = !1),
      r.insertMode || Xe.signal(e, "vim-mode-change", {mode: "normal"}),
          Ue(r);
    }
    ...
    function ue(e, t, r, n, o) {
          ...
          var i,
              ...
              a =
                  ((a = (i = e).getCursor("head")),
                      (a =
                          1 == i.getSelection().length ? G(a, i.getCursor("anchor")) : a)),
              s = e.getLine(a.line),
              l = a.ch,
              c = (o ? m : g)[0];
          !c(s.charAt(l));
      ...
      n ? (c = g[0]) : (c = m[0])(s.charAt(l)) || (c = m[1]);
      for (var u = l, h = l; c(s.charAt(u)) && u < s.length;) u++;
      for (; c(s.charAt(h)) && 0 <= h;) h--;
      if ((h++, t)) {
        for (t = u; /\s/.test(s.charAt(u)) && u < s.length;) u++;
        if (t == u) {
          for (t = h; /\s/.test(s.charAt(h - 1)) && 0 < h;) h--;
          h = h || t;
        }
      }
      return {start: et(a.line, h), end: et(a.line, u)};
    }

    function he(e, t, r) {
      X(t, r) || E.jumpList.add(e, t, r);
    }

    function pe(e, t) {
      (E.lastCharacterSearch.increment = e),
          (E.lastCharacterSearch.forward = t.forward),
          (E.lastCharacterSearch.selectedCharacter = t.selectedCharacter);
    }
    ...
    function me(e, t, r, n, o) {
      (t = et(t.line + r.repeat - 1, 1 / 0)), (r = e.clipPos(t));
      return (
          r.ch--,
          o ||
          ((n.lastHPos = 1 / 0), (n.lastHSPos = e.charCoords(r, "div").left)),
              t
      );
    }
    ...
    function ye(t, e, r, n, o) {
      ...
      function u(e, t, r) {
        return r ? c(e) != c(e + t) : !c(e) && c(e + t);
      }

      if (n) {
        for (; a <= l && l <= s && 0 < r;) u(l, n) && r--, (l += n);
        return new et(l, 0);
      }
      var h,
          e = t.state.vim;
      e.visualLine &&
      u(i, 1, !0) &&
      u((h = e.sel.anchor).line, -1, !0) &&
      ((o && h.line == i) || (i += 1));
      for (var p = c(i), l = i; l <= s && r; l++)
        u(l, 1, !0) && ((o && c(l) == p) || r--);
      for (
          h = new et(l, 0), s < l && !p ? (p = !0) : (o = !1), l = i;
          a < l && ((o && c(l) != p && l != i) || !u(l, -1, !0));
          l--
      ) ;
      return {start: new et(l, 0), end: h};
    }
    ...
    function Ce(e) {
      e = e.state.vim;
      return e.searchState_ || (e.searchState_ = new ke());
    }
    ...
    function be(e, t, r) {
      if (
          (E.registerController.getRegister("/").setText(e), e instanceof RegExp)
      )
        return e;
      var n,
          o,
    ...
    function Le(e) {
      ...
      for (var t, r = 1; r < arguments.length; r++)
        if ((t = arguments[r]))
          if (
              (t = "object" != typeof t ? document.createTextNode(t) : t).nodeType
          )
            e.appendChild(t);
          else
            for (var n in t)
    ...
    function Te(e, t) {
      t = Le("pre", {$color: "red"}, t);
      e.openNotification
          ? e.openNotification(t, {bottom: !0, duration: 5e3})
          : alert(t.innerText);
    }
    ...
    function Ke(e) {
      var t = e.getScrollInfo(),
          ...
          t = t.clientHeight - 10 + t.top,
          t = e.coordsChar({left: 0, top: t}, "local");
      return {top: r.line, bottom: t.line};
    }

    function Pe(e, t, r) {
      if ("'" == r || "`" == r) return E.jumpList.find(e, -1) || et(0, 0);
      if ("." == r) return je(e);
      r = t.marks[r];
      return r && r.find();
    }
    ...
    d.prototype = {
      ...
      _processCommand: function (t, e, r) {
        var n = t.state.vim,
            o = E.registerController.getRegister(":"),
            i = o.toString();
        n.visualMode && le(t);
        n = new Xe.StringStream(e);
        o.setText(e);
        var a,
            s,
            r = r || {};
        r.input = e;
        try {
          this.parseInput_(t, n, r);
        } catch (e) {
          throw (Te(t, e.toString()), e);
        }
        if (r.commandName) {
          if ((a = this.matchCommand_(r.commandName))) {
            if (
                ((s = a.name),
                a.excludeFromCommandHistory && o.setText(i),
                    this.parseCommandArgs_(n, r, a),
                "exToKey" == a.type)
            ) {
              for (var l = 0; l < a.toKeys.length; l++)
                Xe.Vim.handleKey(t, a.toKeys[l], "mapping");
              return;
            }
            if ("exToEx" == a.type)
              return void this.processCommand(t, a.toInput);
          }
        } else void 0 !== r.line && (s = "move");
        if (s)
          try {
            _e[s](t, r), (a && a.possiblyAsync) || !r.callback || r.callback();
          } catch (e) {
            throw (Te(t, e.toString()), e);
          }
        else Te(t, 'Not an editor command ":' + e + '"');
      },
      parseInput_: function (e, t, r) {
        ...
        e = t.match(/^(\w+|!!|@@|[!#&*<=>@~])/);
        return (r.commandName = e ? e[1] : t.match(/.*/)[0]), r;
      },
      parseLineSpec_: function (e, t) {
        ...
        switch (t.next()) {
          ...
          case "'":
            var n = t.next(),
                n = Pe(e, e.state.vim, n);
            if (!n) throw new Error("Mark not set");
            return this.parseLineSpecOffset_(t, n.line);
          case "-":
          case "+":
            return (
      ...
      parseLineSpecOffset_: function (e, t) {
        var r = e.match(/^([+-])?(\d+)/);
        return (
            r && ((e = parseInt(r[2], 10)), "-" == r[1] ? (t -= e) : (t += e)), t
        );
      },
      ...
      unmap: function (e, t) {
        if (":" != e && ":" == e.charAt(0)) {
          ...
          for (var n = e, o = 0; o < Ze.length; o++)
            if (n == Ze[o].keys && Ze[o].context === t)
              return void Ze.splice(o, 1);
    ...
    var _e = {
          colorscheme: function (e, t) {
            !t.args || t.args.length < 1
                ? Te(e, e.getOption("theme"))
                : e.setOption("theme", t.args[0]);
          },
          map: function (e, t, r) {
            var n = t.args;
            !n || n.length < 2
                ? e && Te(e, "Invalid mapping: " + t.input)
                : He.map(n[0], n[1], r);
          },
          imap: function (e, t) {
            this.map(e, t, "insert");
          ...
          unmap: function (e, t, r) {
            var n = t.args;
            !n || n.length < 1
                ? e && Te(e, "No such mapping: " + t.input)
                : He.unmap(n[0], r);
          },
          move: function (e, t) {
          ...
          set: function (e, t) {
            var r = t.args,
                n = t.setCfg || {};
            if (!r || r.length < 1) e && Te(e, "Invalid mapping: " + t.input);
            else {
              var o = r[0].split("="),
                  i = o[0],
                  r = o[1],
              ...
              if ("?" == i.charAt(i.length - 1)) {
                if (r) throw Error("Trailing characters: " + t.argString);
                (i = i.substring(0, i.length - 1)), (o = !0);
              }
              void 0 === r &&
              "no" == i.substring(0, 2) &&
              ((i = i.substring(2)), (r = !1));
              t = M[i] && "boolean" == M[i].type;
              t && null == r && (r = !0),
                  (!t && void 0 === r) || o
                      ? (o = L(i, e, n)) instanceof Error
                          ? Te(e, o.message)
                          : Te(
                              e,
                              !0 === o || !1 === o
                      ...
                      : (n = b(i, r, e, n)) instanceof Error && Te(e, n.message);
            }
          },
          ...
          registers: function (e, t) {
            var r = t.args,
                n = E.registerController.registers,
                o = "----------Registers----------\n\n";
            if (r)
              for (var r = r.join(""), i = 0; i < r.length; i++)
                (a = r.charAt(i)),
                E.registerController.isValidRegister(a) &&
                (o += '"' + a + "    " + (n[a] || new j()).toString() + "\n");
            else
              for (var a in n) {
                var s = n[a].toString();
                s.length && (o += '"' + a + "    " + s + "\n");
          ...
          sort: function (e, o) {
            ...
            var t = (function () {
              if (o.argString) {
                var e = new Xe.StringStream(o.argString);
                if ((e.eat("!") && (i = !0), !e.eol())) {
                  if (!e.eatSpace()) return "Invalid arguments";
                  var t = e.match(/([dinuox]+)?\s*(\/.+\/)?\s*/);
                  if (!t && !e.eol()) return "Invalid arguments";
                  if (t[1]) {
                    (a = -1 != t[1].indexOf("i")), (s = -1 != t[1].indexOf("u"));
                    var r =
                            -1 != t[1].indexOf("d") || (-1 != t[1].indexOf("n") && 1),
                        n = -1 != t[1].indexOf("x") && 1,
                        e = -1 != t[1].indexOf("o") && 1;
                    if (1 < r + n + e) return "Invalid arguments";
                    l = (r ? "decimal" : n && "hex") || (e && "octal");
                  }
                  t[2] &&
                  (c = new RegExp(
            ...
            if (t) Te(e, t + ": " + o.argString);
            else {
              var r = o.line || e.firstLine(),
                  t = o.lineEnd || o.line || e.lastLine();
              if (r != t) {
                var r = et(r, 0),
                    t = et(t, te(e, t)),
                    n = e.getRange(r, t).split("\n"),
                    u =
                        c ||
                        ("decimal" == l
                            ? /(-?)([\d]+)/
                ...
                if (l || c)
                  for (var f = 0; f < n.length; f++) {
                    var m = c ? n[f].match(c) : null;
                    m && "" != m[0]
                        ? p.push(m)
                        : (!c && u.exec(n[f]) ? p : d).push(n[f]);
                  }
                else d = n;
                if (
                    (p.sort(
                  ...
                  for (f = 0; f < p.length; f++) p[f] = p[f].input;
                else l || d.sort(y);
                if (((n = i ? p.concat(d) : d.concat(p)), s))
                  for (var g, v = n, n = [], f = 0; f < v.length; f++)
                    v[f] != g && n.push(v[f]), (g = v[f]);
                e.replaceRange(n.join("\n"), r, t);
              }
            }
            ...
            function y(e, t) {
              ...
              var r = l && u.exec(e),
                  n = l && u.exec(t);
              return r
                  ? parseInt((r[1] + r[2]).toLowerCase(), h) -
                  (n = parseInt((n[1] + n[2]).toLowerCase(), h))
                  : e < t
                      ? -1
                      : 1;
            }
          ...
          global: function (t, e) {
            ...
            if (r) {
              var n,
                  o = "v" === e.commandName[0],
                  i = void 0 !== e.line ? e.line : t.firstLine(),
                  a = e.lineEnd || e.line || t.lastLine(),
                  e = we(r, "/"),
                  r = r;
              if (
                  (e.length && ((r = e[0]), (n = e.slice(1, e.length).join("/"))),
                      r)
              )
                try {
                  Ee(t, r, !0, !0);
                } catch (e) {
                  return void Te(t, "Invalid regex: " + r);
                }
              for (var s, l, c = Ce(t).getQuery(), u = [], h = i; h <= a; h++) {
                var p = t.getLineHandle(h);
                c.test(p.text) !== o && u.push(n ? p : p.text);
              }
              n
                  ? ((s = 0),
                      (l = function () {
                        ...
                        s < u.length &&
                        ((e = u[s++]),
                            null != (e = t.getLineNumber(e))
                                ? ((e = e + 1 + n),
                                    He.processCommand(t, e, {callback: l}))
                                : l());
                      })())
                  : Te(t, u.join("\n"));
            } else Te(t, "Regular Expression missing from global");
          },
          substitute: function (t, e) {
            ...
            if (s.length)
              (o = s[0]),
              L("pcre") && "" !== o && (o = new RegExp(o).source),
                  (l = s[1]),
              /(^|[^\\])(\\\\)*\$$/.test(o) &&
              ((o = o.slice(0, -1) + "\\n"), (l = (l || "") + "\n")),
              void 0 !== l &&
              ((l = L("pcre")
                  ? (function (e) {
                    for (var t = new Xe.StringStream(e), r = []; !t.eol();) {
            ...
            if (
              ...
              try {
                ...
                return void Te(t, "Invalid regex: " + o);
              }
            void 0 !== (l = l || E.lastSubstituteReplacePart)
                ? ((r = Ce(t).getQuery()),
                    (n = (void 0 !== e.line ? e : t.getCursor()).line),
                    (o = e.lineEnd || n),
                n == t.firstLine() && o == t.lastLine() && (o = 1 / 0),
                i && (o = (n = o) + i - 1),
                    (i = U(t, et(n, 0))),
                    (i = t.getSearchCursor(r, i)),
                    (function (o, e, n, i, a, s, r, l, c) {
                      ...
                      function m() {
                        var e = o.getRange(s.from(), s.to()).replace(r, l),
                            t = s.to().line;
                        s.replace(e), (h = s.to().line), (a += h - t), (p = h < t);
                      }
                      ...
                      function v(e) {
                        ...
                        u &&
                        (o.setCursor(u),
                            ((e = o.state.vim).exMode = !1),
                            (e.lastHPos = e.lastHSPos = u.ch)),
                        c && c();
                      }

                      g(),
                          d
                              ? Te(o, "No matches for " + r.source)
                              : e
                                  ? Re(o, {
                                    prefix: Le(
                                        "span",
                                    ...
                                    onKeyDown: function (e, t, r) {
                                      switch ((Xe.e_stop(e), Xe.keyName(e))) {
                                        case "Y":
                                          m(), g();
                                          break;
                                        case "N":
                                  ...
                                  : (f(), c && c());
                    })(t, c, u, n, o, i, r, l, e.callback))
                : Te(t, "No previous substitute regular expression");
          },
          redo: Xe.commands.redo,
          undo: Xe.commands.undo,
          write: function (e) {
            Xe.commands.save ? Xe.commands.save(e) : e.save && e.save();
          },
          ...
          yank: function (e) {
            var t = z(e.getCursor()).line,
                t = e.getLine(t);
            E.registerController.pushText("0", "yank", t, !0, !0);
          },
          delmarks: function (e, t) {
            if (t.argString && re(t.argString))
              for (
                  var r = e.state.vim, n = new Xe.StringStream(re(t.argString));
                  !n.eol();
              ) {
                n.eatSpace();
                var o = n.pos;
                ...
                if (n.match("-", !0)) {
                  ...
                  var a = i,
                      s = n.next();
                  if (!((k(a) && k(s)) || (C(a) && C(s))))
                    return void Te(e, "Invalid argument: " + a + "-");
    ...
    function Fe(e) {
      var t = e.state.vim,
          r = E.macroModeState,
          n = E.registerController.getRegister("."),
          o = r.isPlaying,
          i = r.lastInsertModeChanges;
      o || (e.off("change", De), Xe.off(e.getInputField(), "keydown", qe)),
      !o &&
      1 < t.insertModeRepeat &&
      (Qe(e, t, t.insertModeRepeat - 1, !0),
      ...
      ((e = r).isPlaying ||
          ((r = e.latestRegister),
          (r = E.registerController.getRegister(r)) &&
          ...
          (o.expectCursorActivityForChange = !0),
              1 < o.ignoreCount
                  ...
                  : ("+input" != t.origin &&
                      "paste" != t.origin &&
                      void 0 !== t.origin) ||
                  (1 < (r = e.listSelections().length) && (o.ignoreCount = r),
                      (r = t.text.join("\n")),
    ...
    function qe(e) {
      var t = E.macroModeState.lastInsertModeChanges,
          r = Xe.keyName(e);
      r &&
      ((-1 == r.indexOf("Delete") && -1 == r.indexOf("Backspace")) ||
          Xe.lookupKey(r, "vim-insert", function () {
            return (
                t.maybeReset && ((t.changes = []), (t.maybeReset = !1)),
                    t.changes.push(new Je(r)),
                    !0
            );
          }));
    }
    ...
    function Qe(r, n, e, t) {
      ...
      (n.inputState = a), n.insertMode && !t && Fe(r), (o.isPlaying = !1);
    }

    function ze(t, e, r) {
      function n(e) {
        return "string" == typeof e ? Xe.commands[e](t) : e(t), !0;
      }

      var o = t.getCursor("head"),
          i = E.macroModeState.lastInsertModeChanges.visualBlock;
      ...
      for (var a = 0; a < r; a++) {
        ...
        for (var s = 0; s < e.length; s++) {
          var l,
              ...
              u = e[s];
          u instanceof Je
              ? Xe.lookupKey(u.keyName, "vim-insert", n)
              : "string" == typeof u
                  ? ((c = t.getCursor()), t.replaceRange(u, c, c))
                  : ((c = q((l = t.getCursor()), 0, u[0].length)),
                      t.replaceRange(u[0], l, c));
        }
      }
    ...
    return (
        (Xe.keyMap.vim = {attach: n, detach: e, call: t}),
            S("insertModeEscKeysTimeout", 200, "number"),
            (Xe.keyMap["vim-insert"] = {
              fallthrough: ["default"],
              attach: n,
              detach: e,
              call: t,
            }),
            (Xe.keyMap["vim-replace"] = {
