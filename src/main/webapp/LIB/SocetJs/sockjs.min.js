  ...
  return function i(s, a, l) {
    ...
    11: [function (n, o, e) {
      (function (u) {
        (function () {
          "use strict";
          var r = n("events").EventEmitter, e = n("inherits"), i = n("./utils/event"), s = n("./transport/iframe"),
              a = n("./info-iframe-receiver"), l = function () {
              };
      ...
      (function (w) {
        (function () {
          ...
          var r, l = x("url-parse"), e = x("inherits"), u = x("./utils/random"), t = x("./utils/escape"),
              c = x("./utils/url"), i = x("./utils/event"), n = x("./utils/transport"), o = x("./utils/object"),
              f = x("./utils/browser"), h = x("./utils/log"), s = x("./event/event"), d = x("./event/eventtarget"),
              p = x("./location"), a = x("./event/close"), m = x("./event/trans-message"), v = x("./info-receiver"),
              b = function () {
              };
    ...
    17: [function (o, f, e) {
      (function (r) {
        (function () {
          "use strict";
          var i = o("events").EventEmitter, e = o("inherits"), s = o("../../utils/event"), a = o("../../utils/url"),
              l = r.XMLHttpRequest, u = function () {
              };
    ...
    20: [function (e, t, n) {
      "use strict";
      var r = e("inherits"), o = e("./lib/ajax-based"), i = e("./receiver/eventsource"), s = e("./sender/xhr-cors"),
          a = e("eventsource");
    ...
    30: [function (n, c, e) {
      (function (u) {
        (function () {
          "use strict";
          var e = n("inherits"), r = n("../../utils/iframe"), o = n("../../utils/url"), i = n("events").EventEmitter,
              s = n("../../utils/random"), a = function () {
              };
    ...
    34: [function (r, u, e) {
      (function (l) {
        (function () {
          "use strict";
          var o = r("events").EventEmitter, e = r("inherits"), i = r("../../utils/event"), t = r("../../utils/browser"),
              s = r("../../utils/url"), a = function () {
              };
    ...
    42: [function (l, u, e) {
      (function (a) {
        (function () {
          "use strict";
          var e = l("inherits"), t = l("./lib/ajax-based"), n = l("./receiver/xhr"), r = l("./sender/xhr-cors"),
              o = l("./sender/xhr-local"), i = l("../utils/browser");
      ...
      (function (a) {
        (function () {
          ...
          var d = e("requires-port"), p = e("querystringify"),
              t = /^[\x00-\x20\u00a0\u1680\u2000-\u200a\u2028\u2029\u202f\u205f\u3000\ufeff]+/, m = /[\n\r\t]/g,
              i = /^[A-Za-z][A-Za-z0-9+-.]*:\/\//, l = /:\d+$/, u = /^([a-z][a-z0-9.+-]*:)?(\/\/)?([\\/]+)?([\S\s]*)/i,
              v = /^[a-zA-Z]:/;
